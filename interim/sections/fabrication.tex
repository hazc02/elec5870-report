...
To pattern these contacts cleanly, a dual-layer resist stack of LOR beneath S1803 was used.
A single resist layer develops near-vertical sidewalls, causing the evaporated metal to form a
continuous film across both the wafer surface and the resist edges. This continuity makes lift-off
...
metal so the film on top of the resist is physically separated from the metal inside the opening.
When the LOR dissolves during lift-off, the unwanted metal lifts away cleanly, leaving sharply
...
A AuGe/Ni/Au metallisation stack was then deposited by thermal evaporation to form the
