...
\begin{figure}[H]
  \centering
  \begin{tikzpicture}[x=1cm,y=0.9cm,>=Stealth,font=\footnotesize]

    % Axes labels
    \node[anchor=north] at (1.5,0) {AlGaAs};
    \node[anchor=north] at (6,0) {GaAs};
  ...
  \end{tikzpicture}
  \caption{Conduction and valence band alignment at the AlGaAs/GaAs interface showing band bending and the resulting two-dimensional electron gas (2DEG) in a quantum well.}
