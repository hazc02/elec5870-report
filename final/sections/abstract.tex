...
This report presents the design, fabrication and characterisation 
of enhancement-mode GaAs/AlGaAs high-electron-mobility transistors formed by gate
...
geometry, gate layout and etch-depth control. The final set of devices
...
investigated. These results confirm the relationship between gate recess 
depth and threshold voltage: greater recess depths produce 
a correspondingly positive shift in $V_{th}$.
...
control, reduced drain-source current after recession and gate leakage. 
The final devices therefore provide both a proof of principle and a basis for 
assessing how the process could be improved for more repeatable 
normally-off GaAs HEMTs.
