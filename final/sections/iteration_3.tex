...
\begin{table}[htbp]
  \centering
  \caption{Summary of the Iteration 3 quadrant structure. Sample 1 was the
  non-oxide sample and sample 2 was the oxide sample.}
...
\begin{figure}[htbp]
  ...
  \caption{Optical microscope image of the etched gate-recess region after gate
  lithography development on the oxide sample}
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption{Optical microscope images comparing gate metal lift-off in Iteration
  3. The non-oxide sample suffered from local metal retention, which produced
  short-circuit paths on some devices. The oxide sample shown here exhibited a
  cleaner gate formation after lift-off.}
...
\begin{figure}[htbp]
  ...
  \caption{Low-magnification optical microscope image of an Iteration 3 oxide
  quadrant after gate lift-off. This image shows the broader device layout after
  completion of the recess and gate formation steps.}
...
\begin{figure}[htbp]
  \centering
  \makebox[\linewidth][c]{\hspace*{-0.04\linewidth}\includegraphics[width=0.9\linewidth]{figures/electrical_analysis/enhancement_mode/iteration_3/gate_transfer.png}}
  \caption{Gate-transfer characteristics for the Iteration 3 non-oxide devices.
  The recessed devices etched for \SI{45}{\second} and \SI{60}{\second} are
  compared with the available unrecessed control from the \SI{45}{\second}
  sample. The recessed devices show enhancement-mode behaviour, with the longer
  etch producing the more positive threshold voltage and lower drain-source
  current.}
...
\begin{figure}[htbp]
  \centering
  \makebox[\linewidth][c]{\hspace*{-0.04\linewidth}\includegraphics[width=0.88\linewidth]{figures/electrical_analysis/enhancement_mode/iteration_3/gate_oxide_q2_transfer.png}}
  \caption{Gate-transfer characteristic comparing a recessed oxide device with
  its unrecessed oxide control. The recessed oxide device did not turn on within
  the measured gate-bias range, while the unrecessed oxide control retained
  depletion-mode transistor behaviour.}
  \label{fig:iteration3-oxide-transfer}
\end{figure}

% Maximum tested gate voltage to be inserted:
% maximum tested Vg = [VALUE] V.
...
\begin{figure}[htbp]
  \centering
  \makebox[\linewidth][c]{\hspace*{-0.04\linewidth}\includegraphics[width=0.9\linewidth]{figures/electrical_analysis/enhancement_mode/iteration_3/gate_leakage.png}}
  \caption{Gate-leakage comparison between unrecessed devices with and without
  the oxide layer. The oxide reduces the measured gate current to the picoamp
  range, demonstrating the leakage suppression expected from the added
  insulating layer.}
...
\begin{figure}[htbp]
  \centering
  \makebox[\linewidth][c]{\hspace*{-0.04\linewidth}\includegraphics[width=0.9\linewidth]{figures/electrical_analysis/enhancement_mode/iteration_3/gate_leakage_recess.png}}
  \caption{Gate-leakage behaviour of the recessed Iteration 3 devices. The
  oxide-gated recessed device shows much lower leakage than the non-oxide
  recessed device, although this leakage improvement was not accompanied by a
  functioning recessed oxide transistor in this iteration.}
