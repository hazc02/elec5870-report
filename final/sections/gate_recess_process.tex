...
AlGaAs rate was particularly attractive because the donor layer is the
depth-critical region of the recess; a slower AlGaAs etch was expected to
increase the process tolerance once the GaAs cap had been removed.

\vspace{1mm}

To characterise the etching behaviour of this chemistry, a series calibration 
...
indicates that the apparent etch rate governed not only by the 
...
The dependence of apparent etch rate on interval duration is attributed to
