...
\usepackage{placeins} % allow FloatBarrier to flush queued floats
...
\hypersetup{
  ...
  pdftitle={ELEC5870M Final Report}
}
...
% Figure and table caption style and tighter float spacing
\captionsetup{font=small,labelfont=bf}
\setlength{\textfloatsep}{6pt plus 2pt minus 2pt} % text to top/bottom floats
\setlength{\floatsep}{6pt plus 2pt minus 2pt}    % float to float
\setlength{\intextsep}{6pt plus 2pt minus 2pt}   % inline (e.g., [H]) floats
