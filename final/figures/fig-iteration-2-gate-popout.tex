...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    \node[anchor=north west, inner sep=0pt] (xTwenty) at (0,0) {
      \includegraphics[width=0.48\linewidth]{figures/fabrication_images/enhancement_mode_images/iteration2/gate-formation.jpg}
    };

    \node[anchor=north west, inner sep=0pt] (xHundred) at ($(xTwenty.north east)+(0.04\linewidth,0)$) {
      \includegraphics[width=0.48\linewidth]{figures/fabrication_images/enhancement_mode_images/iteration2/gate_formation_x100.jpg}
    };
  ...
  \vspace{3pt}
  \caption{Iteration 2 gate formation microscopy, showing the device-level
  view on the left and a higher-magnification view of the gate crossing the
  mesa region on the right.}
