...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    recessbox/.style={dashed, line width=1.5pt},
    ...
    \node[anchor=north west, inner sep=0pt] (device) at (0,0) {
      \includegraphics[width=0.78\linewidth]{figures/fabrication_images/enhancement_mode_images/current_path_annotate.jpg}
    };
    ...
    \path let \p1=(device.north west), \p2=(device.south east) in
      ...
      coordinate (leftUpperStart) at ({\x1+0.305*(\x2-\x1)}, {\y1+0.295*(\y2-\y1)})
      coordinate (leftUpperA) at ({\x1+0.382*(\x2-\x1)}, {\y1+0.220*(\y2-\y1)})
      coordinate (leftUpperB) at ({\x1+0.412*(\x2-\x1)}, {\y1+0.218*(\y2-\y1)})
      coordinate (leftUpperEnd) at ({\x1+0.487*(\x2-\x1)}, {\y1+0.286*(\y2-\y1)})
      coordinate (leftLowerStart) at ({\x1+0.305*(\x2-\x1)}, {\y1+0.400*(\y2-\y1)})
      coordinate (leftLowerA) at ({\x1+0.375*(\x2-\x1)}, {\y1+0.455*(\y2-\y1)})
      coordinate (leftLowerEnd) at ({\x1+0.490*(\x2-\x1)}, {\y1+0.382*(\y2-\y1)})
      coordinate (rightUpperStart) at ({\x1+0.695*(\x2-\x1)}, {\y1+0.295*(\y2-\y1)})
      coordinate (rightUpperA) at ({\x1+0.598*(\x2-\x1)}, {\y1+0.220*(\y2-\y1)})
      coordinate (rightUpperB) at ({\x1+0.568*(\x2-\x1)}, {\y1+0.218*(\y2-\y1)})
      coordinate (rightUpperEnd) at ({\x1+0.513*(\x2-\x1)}, {\y1+0.286*(\y2-\y1)})
      coordinate (rightLowerStart) at ({\x1+0.695*(\x2-\x1)}, {\y1+0.400*(\y2-\y1)})
      coordinate (rightLowerA) at ({\x1+0.605*(\x2-\x1)}, {\y1+0.455*(\y2-\y1)})
      coordinate (rightLowerEnd) at ({\x1+0.510*(\x2-\x1)}, {\y1+0.382*(\y2-\y1)})
      coordinate (recessText) at ({\x1+0.49*(\x2-\x1)}, {\y1+0.305*(\y2-\y1)});

    \draw[recessbox, blue!70!black] (recessNW) rectangle (recessSE);
