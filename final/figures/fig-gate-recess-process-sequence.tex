...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[x=0.72cm, y=0.42cm, >=Stealth, font=\scriptsize]
    ...
    \def\yfloor{4.35}
    \def\yfloorB{3.95}
    \def\headerY{\ytop+2.10}

    % Preserve the extra vertical clearance above the devices after resizing.
    \path[use as bounding box] (-0.2,-0.2) rectangle (25.9,\headerY+0.25);
  ...
  \vspace{1mm}
  \caption{Cross-sectional sequence for forming the recessed-gate
  enhancement-mode HEMT between ohmic contact and gate formation.}
