...
\begin{figure}[htbp]
  ...
  \vspace{2mm}
  \caption{Iteration 1 Mask Structure, showing the mask at device-level, 
  a zoomed view of the gate and recess structure relative to the drain and source, 
  and finally gate recess structure with dimensions in microns. (Recess Layer: Green,  Gate Layer: Blue)}
