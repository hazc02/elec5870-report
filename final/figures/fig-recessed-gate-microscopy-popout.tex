% ------------------------------------------------------------
% File: figures/fig-recessed-gate-microscopy-popout.tex
% Recessed gate microscopy callout: x20 image -> x100 image
% ------------------------------------------------------------
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    \def\xTwentyBoxLeft{0.33}
    \def\xTwentyBoxRight{0.43}
    \def\xTwentyBoxTop{0.40}
    \def\xTwentyBoxBottom{0.54}

    \node[anchor=north west, inner sep=0pt] (xTwenty) at (0,0) {
      \includegraphics[width=0.48\linewidth]{figures/fabrication_images/enhancement_mode_images/recessed_gate.jpg}
    };

    \node[anchor=north west, inner sep=0pt] (xHundred) at ($(xTwenty.north east)+(0.04\linewidth,0)$) {
      \includegraphics[width=0.48\linewidth]{figures/fabrication_images/enhancement_mode_images/recessed_gate_x100.jpg}
    };
  ...
  \vspace{3pt}
  \caption{Completed Recessed Gate Microscopy (20x Zoom Left, 100x Zoom Right)}
  \label{fig:recessed-gate-microscopy}
\end{figure}
